...
class Dbh
{
    ...
    {
        $pdo->exec("CREATE TABLE IF NOT EXISTS `db_camagru`.`tb_accounts`(
    ...
    public function insertAccDetails($pdo, $name, $mail, $pwd, $hashKey, $notif)
    {
        $statement = $pdo->prepare("INSERT INTO `tb_accounts` (`id`, `user_name`, `email_addr`, `password`, `hash_key`, `active`, `notifications`)
                        VALUES (NULL, :uname, :mail, :pwd, :hashkey, 0, :notif);");
    ...
    {
        $pdo->exec("CREATE TABLE IF NOT EXISTS `db_camagru`.`tb_images` ( 
    ...
    {
        $pdo->exec("CREATE TABLE IF NOT EXISTS `db_camagru`.`tb_comments` (
                `id` INT NOT NULL AUTO_INCREMENT , 
    ...
    {
        $pdo->exec("CREATE TABLE IF NOT EXISTS `db_camagru`.`tb_likes` ( 
            `id` INT NOT NULL AUTO_INCREMENT , 
            `img_id` INT NULL DEFAULT NULL , 
